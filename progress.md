...
- **Extension render hooks**: `MessageRenderer` is wired; `registerEntryRenderer` / `registerMarkdownTransformer` are recorded but not applied at transcript/tree render time.
