...
impl Provider for AnthropicProvider {
    ...
    async fn stream(
        ...
        let api_key = options
            .api_key
            .clone()
            .or_else(|| crate::auth::get_env_api_key_for_provider("anthropic"))
            .ok_or_else(|| Error::NoApiKey("anthropic".to_string()))?;
        ...
        tokio::spawn(async move {
            let mut msg = AssistantMessage {
                ...
                model: model_id,
                response_model: None,
                response_id: Some("msg_test".to_string()),
                usage: Usage::default(),
            ...
            let text = "Anthropic response placeholder";
